...
- Shows clearer search empty states, no-inventory states, and offline inventory messaging.
...
- Schedules order-specific local Expo notifications for Friday confirmation and Sunday pickup reminders.
...
10. Show About tab for mission, impact, trust principles, timeline, team, branches, and customer testimonials.
...
- Saved/favorite items are not implemented; product cards use a meaningful FREE badge rather than a fake heart.
