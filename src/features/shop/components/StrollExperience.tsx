    ...
    >
      ...
      >
        ...
        <AnimatedG y={bodyTranslateY as never}>
          ...
          <RecycleArrows />
          <Circle cx="100" cy="114" fill="#101010" r="9" />
          <Circle cx="124" cy="114" fill="#101010" r="9" />
          {mood === "cheer" ? (
            <Path d="M 98 130 Q 112 147 126 130 Q 112 139 98 130 Z" fill="#101010" />
          ) : (
            <Path
              d="M 96 131 Q 112 142 128 131"
              fill="none"
              stroke="#101010"
              strokeLinecap="round"
              strokeWidth="6"
